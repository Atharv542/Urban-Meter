    ...
    if (ref) {
      ...
      if (place && place.geometry) {
        if (!place.formatted_address.includes("Delhi")) {
          toast.error("Please select a place within Delhi.");
          return;
        }
        const coords = {
  ...
  return (
    <div className="w-full sm:px-10 md:px-32 lg:px-56 xl:px-10 bg-gradient-to-b from-black to-purple-900">
      <h2 className="font-bold text-2xl py-5 text-white px-14">
        Auto Fares Made <span className="text-[#FF00FF]">Easy</span> – Estimate Before{" "}
        <span className="text-[#FF00FF]">You Go!</span>
      </h2>
        ...
        <LoadScript googleMapsApiKey={GOOGLE_API_KEY} libraries={libraries}>
          <div className="flex flex-col md:flex-row gap-10">
            <div className="p-6 rounded-lg w-[650px] h-[450px] shadow-lg border-5 border-[#9A6C6D] bg-gradient-to-b from-black to-purple-900">
              <h1 className="text-3xl font-bold mb-6 mt-6 text-center text-white">Auto Fare</h1>
            ...
            <div className="flex justify-center">
              {showResults ? (
                ...
                <img src="/rickshaw.jpg" alt="Rickshaw" className="w-lg rounded-lg shadow-lg" />
              )}
            </div>
          </div>
